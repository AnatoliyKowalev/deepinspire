...
const Intro: FC = () => (
  <section className="h-screen min-h-187.5 xs:min-h-208 bg-accent-dark pt-39 xs:pt-31 md:pt-39 sxs:pr-8 font-montserrat xs:pl-15 1xl:pt-54 md:min-h-[1050px] xl:min-h-auto xl:h-[650px] xl:h-[970px] relative">
