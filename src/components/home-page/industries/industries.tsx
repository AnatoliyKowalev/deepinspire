      ...
      <div className="container grid gap-10 lg:grid-cols-12 lg:gap-7 xl:gap-0">
        <div className="lg:col-span-7">
          ...
          <SectionDesc>
            ...
            forefront of fintech development, we understand how it is evolving
            and are always one step ahead.
          </SectionDesc>
          <SectionDesc secondary>
            DeepInspire has consistently reaffirmed its position as one of the
            top fintech companies annually since 2021.
          </SectionDesc>
        </div>
        <Image
